...
public class MeasureMapStore implements MapStore<String,String>{
	...
	public void store(String key, String value) {
		...
		HbaseService.insert(Project503String.MEASUREINFO, key+Project503String.ID_TIME_SPLIT+time, col);
	}
