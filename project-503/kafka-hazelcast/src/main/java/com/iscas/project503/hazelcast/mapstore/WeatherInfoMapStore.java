...
public class WeatherInfoMapStore implements MapStore<String,String>{
	...
	public void store(String key, String value) {
		...
		String termID=JsonToMapParser.findKey(Project503String.MESSAGE_TERM_ID, value);
		String time=JsonToMapParser.findKey("time", value);
		HbaseService.insert(Project503String.WEATHERINFO, termID+Project503String.ID_TIME_SPLIT+time, col);
	}
